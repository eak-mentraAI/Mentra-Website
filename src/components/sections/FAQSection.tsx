...
const faqSections = [
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "Does the AI decide what happens to my child?", answer: "No. Two kinds of intelligence work together, and the division is non-negotiable: deterministic engines decide — whether a child has truly demonstrated understanding, who needs a teacher — by rules, not guesses, so it's provable and the same every time. AI only explains those decisions in plain language. A human always approves. The engine decides, the AI explains, the adult approves — the machine never acts on a child unsupervised." },
  ...
  },
  {
    ...
    questions: [
      ...
      { question: "What is the ontology and knowledge graph you talk about?", answer: "As students work, Mentra captures learning signals and maps them — through a governed ontology, the curated semantic layer that gives every signal a precise meaning and decides whether AI is even allowed to reason on it — into a per-child knowledge graph: a living model of one mind, where concepts connect to what they unlock and struggles connect to their root causes. The ontology is also the safety boundary: it's what lets cognition data flow to partners without ambiguity, and every child's graph is sealed in their own tenant." },
