            ...
            <div className="flex justify-center">
              <div className="flex items-center gap-3 bg-journal-sand rounded-full px-6 py-3">
                <div className="flex -space-x-2">
                  <img src="/lovable-uploads/13ee0557-7701-4480-8818-ad3335de97fd.png" alt="Sprig" className="w-8 h-8 rounded-full border-2 border-white" />
                  <img src="/lovable-uploads/060630a8-ed64-4d31-8e7b-c1c12d2b6e6e.png" alt="Sprig thinking" className="w-8 h-8 rounded-full border-2 border-white" />
                  <img src="/lovable-uploads/cedb8c52-6559-4531-87f6-39ad0937d397.png" alt="Sprig with star" className="w-8 h-8 rounded-full border-2 border-white" />
                </div>
