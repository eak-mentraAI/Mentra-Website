...
export const personas: Persona[] = [
  {
    ...
    blurbs: [
      { icon: ExploreSparks, title: 'Explore What Makes You Curious', text: 'Daily "Sparks" based on your interests. No grades — just discovery that builds genuine curiosity.', color: 'grit-gold' },
      ...
      { icon: XPSprigs, title: 'Earn XP, Unlock Sprigs', text: 'Earn XP for effort and growth — not just right answers. Rewards that recognize the work, not the AI.', color: 'grit-gold' },
  ...
  },
  {
    ...
    blurbs: [
      { icon: IntelligenceHub, title: 'Know Who Needs You First', text: 'Students ranked by urgency with recommended actions. You decide what to do — the AI just makes sure you see it.', color: 'mentra-blue' },
      { icon: WeeklyDigest, title: 'Two-Minute Monday Briefing', text: 'Who needs attention, breakthroughs, and class-wide patterns. Signal, not noise — so you act on what matters.', color: 'curiosity-coral' },
  ...
  },
  {
    ...
    blurbs: [
      ...
      { icon: FullDashboard, title: 'Plain Language, Not Data Dumps', text: 'On Track, Excelling, Needs Practice. Progress you understand without an education degree.', color: 'mentra-blue' },
