  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-journal-sand via-white to-wisdom-purple/10 flex flex-col items-center py-12 px-4">
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <p className="text-gray-700 mb-4">
          Meanwhile, productivity is no longer human-bound. AI agents are outperforming entry-level knowledge workers. Robotics is catching up in physical domains. The very definition of "value" in the economy is changing. This creates a generational opportunity: to build AI-native learning tools that shape emotionally intelligent, adaptable young people, not just task-completers. Tools that help students succeed in traditional metrics, but also prepare them for what comes next.
        </p>
      </section>
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <p className="text-gray-700 mb-4">
          Education is not just a personal pursuit. It is a pillar of democracy, innovation, and opportunity. If we lose this moment, we risk unraveling more than individual futures. We risk the infrastructure of modern society.
        </p>
      </section>
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <ul className="list-disc list-inside text-gray-700 mb-4">
          <li>Concerned parents who feel the urgency firsthand</li>
          <li>Technologists who understand the architecture of the future</li>
          <li>Educators and people leaders who see the classroom not as a commodity, but as a community</li>
        </ul>
        <p className="text-gray-700 mb-4">
      ...
      <section className="w-full max-w-3xl mb-12">
        ...
        <p className="text-gray-700 mb-4">
          That's our vision: A learning system as intelligent, empathetic, and growth-focused as the humans it's meant to support.
        </p>
      </section>
