      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4">
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">Learning Progress</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <FileText className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Student Interactions</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">Engagement Patterns</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Lock className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Data Security</span>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 mt-4">
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <ShieldCheck className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">FERPA Compliant</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <UserCheck className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">COPPA Compliant</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Star className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">SOC 2 Type II</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">GDPR Ready</span>
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4">
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">Socratic Methodology</span>
            <span className="text-gray-900 text-sm text-center">Uses Socratic methodology to guide learning through questions.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <FileText className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Detailed Logs</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">Human Oversight</span>
          ...
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            ...
            <span className="text-mentra-blue font-bold mb-2">Curriculum Standards</span>
            <span className="text-gray-900 text-sm text-center">Follows curriculum standards and educational best practices.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Star className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Continuous Improvement</span>
    ...
    content: (
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 mt-4">
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <UserCheck className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Opt-in/Opt-out</span>
            <span className="text-gray-900 text-sm text-center">Opt-in/opt-out capabilities for AI tutoring features.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <BarChart3 className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Progress Reports</span>
            <span className="text-gray-900 text-sm text-center">Access to detailed progress reports and interaction logs.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Mail className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Communication</span>
            <span className="text-gray-900 text-sm text-center">Regular communication updates about learning activities.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Trash2 className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Data Review & Delete</span>
            <span className="text-gray-900 text-sm text-center">Ability to review and delete collected data.</span>
          </div>
          <div className="bg-white/80 rounded-xl p-4 shadow flex flex-col items-center">
            <Users className="w-8 h-8 text-mentra-blue mb-2" />
            <span className="text-mentra-blue font-bold mb-2">Direct Contact</span>
