        ...
        <section className="container mx-auto max-w-7xl px-4 mb-12 text-left">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6 max-w-6xl">
            ...
            <div className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-sm border">
              <img src="/logo_with_words_white.png" alt="Mentra Logo with Words (White)" className="h-16 mb-3" />
            ...
            <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm border">
              <img src="/lovable-uploads/f05d5e11-f8b1-4798-ba3d-a85133efccfd.png" alt="Mentra Logo with Words (Color)" className="h-16 mb-3" />
            ...
            <div className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-sm border">
              <img src="/logo_icononly_white.png" alt="Mentra Logo Icon Only (White)" className="h-16 mb-3" />
            ...
            {/* Logo No Words (Color) */}
            <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm border">
              <img src="/logo_no_words.png" alt="Mentra Logo No Words (Color)" className="h-16 mb-3" />
            ...
            <div className="flex flex-col items-center bg-white p-4 rounded-lg shadow-sm border">
              <img src="/logo_watermark.png" alt="Mentra Logo Watermark (Color)" className="h-16 mb-3" />
            ...
            <div className="flex flex-col items-center bg-gray-800 p-4 rounded-lg shadow-sm border">
              <img src="/logo_watermark_white.png" alt="Mentra Logo Watermark (White)" className="h-16 mb-3" />
